...
-(void)startDownloadVideo
{
    ...
    _totleNumber = downloadArray.count;
}
...
-(void)segmentDownloadFinished:(SegmentDownloader *)request
{
    ...
    if ([delegate respondsToSelector:@selector(videoDownloaderProgress:)]) {
        CGFloat progress = (_totleNumber - downloadArray.count )/_totleNumber;
        [delegate videoDownloaderProgress:progress];
    }
